...
toolkit_menu() {
    while true; do
        ...
        case "$option" in
            1) cd /tmp && wget --no-check-certificate -O RMxxx_rgmii_toolkit.sh https://gh-proxy.com/https://raw.githubusercontent.com/xfkun233/quectel-rgmii-toolkit/SDXLEMUR/RMxxx_rgmii_toolkit.sh && chmod +x RMxxx_rgmii_toolkit.sh && ./RMxxx_rgmii_toolkit.sh && cd / ;;
            2) cd /tmp && wget --no-check-certificate -O RMxxx_rgmii_toolkit.sh https://gh-proxy.com/https://raw.githubusercontent.com/xfkun233/quectel-rgmii-toolkit/development-SDXLEMUR/RMxxx_rgmii_toolkit.sh && chmod +x RMxxx_rgmii_toolkit.sh && ./RMxxx_rgmii_toolkit.sh && cd / ;;
            3) break ;;

...
install_at_socat() {
    ...
    wget --no-check-certificate $GITROOT/socat-at-bridge/socat-armel-static
    wget --no-check-certificate $GITROOT/socat-at-bridge/killsmd7bridge
    wget --no-check-certificate $GITROOT/socat-at-bridge/atcmd
	wget --no-check-certificate $GITROOT/socat-at-bridge/atcmd11
    cd $SOCAT_AT_SYSD_DIR
    wget --no-check-certificate $GITROOT/socat-at-bridge/systemd_units/socat-smd11.service
    wget --no-check-certificate $GITROOT/socat-at-bridge/systemd_units/socat-smd11-from-ttyIN.service
    wget --no-check-certificate $GITROOT/socat-at-bridge/systemd_units/socat-smd11-to-ttyIN.service
    wget --no-check-certificate $GITROOT/socat-at-bridge/systemd_units/socat-killsmd7bridge.service	
    wget --no-check-certificate $GITROOT/socat-at-bridge/systemd_units/socat-smd7-from-ttyIN2.service
    wget --no-check-certificate $GITROOT/socat-at-bridge/systemd_units/socat-smd7-to-ttyIN2.service
    wget --no-check-certificate $GITROOT/socat-at-bridge/systemd_units/socat-smd7.service

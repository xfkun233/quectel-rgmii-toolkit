...
install_lighttpd() {
    ...
    wget --no-check-certificate -O "$SIMPLE_ADMIN_DIR/lighttpd.conf" $GITROOT/simpleadmin/lighttpd.conf
    wget --no-check-certificate -O "/lib/systemd/system/lighttpd.service" $GITROOT/simpleadmin/systemd/lighttpd.service
...
echo -e "\e[1;31m2) Installing simpleadmin from the $GITTREE branch\e[0m"
            ...
            wget --no-check-certificate $GITROOT/simpleadmin/systemd/lighttpd.service
			sleep 1
			cd $SIMPLE_ADMIN_DIR/script
			wget --no-check-certificate $GITROOT/simpleadmin/script/ttl_script.sh
			wget --no-check-certificate $GITROOT/simpleadmin/script/remove_watchcat.sh
			wget --no-check-certificate $GITROOT/simpleadmin/script/create_watchcat.sh
			sleep 1
			cd $SIMPLE_ADMIN_DIR/console
			wget --no-check-certificate $GITROOT/simpleadmin/console/.profile
			sleep 1
			cd $SIMPLE_ADMIN_DIR/console/menu
			wget --no-check-certificate $GITROOT/simpleadmin/console/menu/start_menu.sh
			ln -f $SIMPLE_ADMIN_DIR/console/menu/start_menu.sh /usrdata/root/bin/menu
			wget --no-check-certificate $GITROOT/simpleadmin/console/menu/sfirewall_settings.sh
			wget --no-check-certificate $GITROOT/simpleadmin/console/menu/start_menu.sh
			sleep 1
			cd $SIMPLE_ADMIN_DIR/www
			wget --no-check-certificate $GITROOT/simpleadmin/www/deviceinfo.html
   			wget --no-check-certificate $GITROOT/simpleadmin/www/favicon.ico
			wget --no-check-certificate $GITROOT/simpleadmin/www/index.html
    		wget --no-check-certificate $GITROOT/simpleadmin/www/network.html
			wget --no-check-certificate $GITROOT/simpleadmin/www/settings.html
			wget --no-check-certificate $GITROOT/simpleadmin/www/sms.html
			wget --no-check-certificate $GITROOT/simpleadmin/www/scanner.html
			wget --no-check-certificate $GITROOT/simpleadmin/www/watchcat.html
			sleep 1
			cd $SIMPLE_ADMIN_DIR/www/js
			wget --no-check-certificate $GITROOT/simpleadmin/www/js/alpinejs.min.js
			wget --no-check-certificate $GITROOT/simpleadmin/www/js/bootstrap.bundle.min.js
			wget --no-check-certificate $GITROOT/simpleadmin/www/js/dark-mode.js
			wget --no-check-certificate $GITROOT/simpleadmin/www/js/generate-freq-box.js
			wget --no-check-certificate $GITROOT/simpleadmin/www/js/parse-settings.js
			wget --no-check-certificate $GITROOT/simpleadmin/www/js/populate-checkbox.js
    		sleep 1
    		cd $SIMPLE_ADMIN_DIR/www/css
    		wget --no-check-certificate $GITROOT/simpleadmin/www/css/bootstrap.min.css
      		wget --no-check-certificate $GITROOT/simpleadmin/www/css/styles.css
      		wget --no-check-certificate $GITROOT/simpleadmin/www/css/all.min.css
      		sleep 1
      		cd $SIMPLE_ADMIN_DIR/www/fonts
      		wget --no-check-certificate $GITROOT/simpleadmin/www/fonts/poppins-v23-latin-300italic.woff2
      		wget --no-check-certificate $GITROOT/simpleadmin/www/fonts/poppins-v23-latin-300.woff2
      		wget --no-check-certificate $GITROOT/simpleadmin/www/fonts/poppins-v23-latin-500italic.woff2
      		wget --no-check-certificate $GITROOT/simpleadmin/www/fonts/poppins-v23-latin-500.woff2
      		wget --no-check-certificate $GITROOT/simpleadmin/www/fonts/poppins-v23-latin-600italic.woff2
      		wget --no-check-certificate $GITROOT/simpleadmin/www/fonts/poppins-v23-latin-600.woff2
      		wget --no-check-certificate $GITROOT/simpleadmin/www/fonts/poppins-v23-latin-700italic.woff2
      		wget --no-check-certificate $GITROOT/simpleadmin/www/fonts/poppins-v23-latin-700.woff2
      		wget --no-check-certificate $GITROOT/simpleadmin/www/fonts/poppins-v23-latin-italic.woff2
      		wget --no-check-certificate $GITROOT/simpleadmin/www/fonts/poppins-v23-latin-regular.woff2
			sleep 1
			cd $SIMPLE_ADMIN_DIR/www/cgi-bin
			wget --no-check-certificate $GITROOT/simpleadmin/www/cgi-bin/get_atcommand
			wget --no-check-certificate $GITROOT/simpleadmin/www/cgi-bin/user_atcommand
			wget --no-check-certificate $GITROOT/simpleadmin/www/cgi-bin/get_ping
			wget --no-check-certificate $GITROOT/simpleadmin/www/cgi-bin/get_sms
    		wget --no-check-certificate $GITROOT/simpleadmin/www/cgi-bin/get_ttl_status
      		wget --no-check-certificate $GITROOT/simpleadmin/www/cgi-bin/set_ttl
			wget --no-check-certificate $GITROOT/simpleadmin/www/cgi-bin/send_sms
			wget --no-check-certificate $GITROOT/simpleadmin/www/cgi-bin/get_uptime
			wget --no-check-certificate $GITROOT/simpleadmin/www/cgi-bin/get_watchcat_status
			wget --no-check-certificate $GITROOT/simpleadmin/www/cgi-bin/set_watchcat
			wget --no-check-certificate $GITROOT/simpleadmin/www/cgi-bin/watchcat_maker
			sleep 1
			cd /
...
install_ttyd() {
    ...
    wget --no-check-certificate "$GITROOT/simpleadmin/console/ttyd.bash" && chmod +x ttyd.bash
    cd $SIMPLE_ADMIN_DIR/systemd/
	wget --no-check-certificate "$GITROOT/simpleadmin/systemd/ttyd.service"
